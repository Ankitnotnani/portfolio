    ...
    <section className="h-screen flex flex-col justify-center items-center relative px-6 overflow-x-clip" id="home">
      <nav className="fixed top-0 left-0 w-full backdrop-blur-sm bg-dark/80 border-b border-white/[0.06] z-50 flex justify-between items-center px-6 md:px-10 py-4 md:py-5">
        ...
        <div className="hidden md:flex gap-6 items-center">
          {['About', 'Journey', 'Projects', 'Contact'].map(link => (
...
const AboutSection = () => (
  <section className="min-h-screen flex flex-col justify-center px-5 sm:px-8 md:px-16 py-20" id="about">
    ...
    <div className="flex justify-center flex-wrap mt-16 gap-8 sm:gap-16">
      ...
      <FadeIn delay={0.4}><AnimatedCounter target="5" label="Major Projects" /></FadeIn>
      <div className="hidden md:block w-px bg-white/10" />
...
const JourneySection = () => {
  const journey = [
    ...
    { year: "2024", title: "First Projects", desc: "Built ExamHub — a distributed online exam system with 5 Spring Boot microservices, JWT auth, and role-based access control. Started exploring ML." },
    { year: "E. 2025", title: "Going Deep into AI/ML", desc: "Built BananaSense AI (MobileNetV2 transfer learning, FastAPI, React.js) and IDEACT (NLP platform, 94.12% F1-Macro mapping hackathon problems to all 17 UN SDGs)." },
    { year: "M. 2025", title: "National Stage", desc: "Grand Finalist — Smart India Hackathon 2025 as Software Lead on KASA (AI-powered QR laser marking for Indian Railways). Grand Finalist — NASA Space Apps Challenge 2025 with ChronoClime." },
    { year: "2026", title: "Industry — Present", desc: "AI & ML Project Intern at Empyrean Consultancy Services. Building crop readiness detection (Unripe / Ready / Overripe) from drone imagery using computer vision." }
  ];
        ...
        <div className="flex flex-col gap-10">
          ...
          <FadeIn delay={0.8} x={-40} className="flex flex-row items-start gap-6 md:gap-10 relative z-10">
            ...
            <div>
              ...
              <p className="text-textMuted font-light text-sm md:text-base leading-relaxed mt-1">Seeking full-time / internship roles in AI/ML or backend SDE where intelligent systems meet real-world impact.</p>
            </div>
          </FadeIn>
        </div>
      </div>
...
const ExpertiseSection = () => {
  ...
  const tags = ["Python", "Java", "C++", "JavaScript", "TypeScript", "React.js", "FastAPI", "Spring Boot", "Flask", "TensorFlow/Keras", "MobileNetV2", "OpenCV", "Scikit-learn", "NLP", "NumPy", "Pandas", "MySQL", "MongoDB", "Docker", "Git", "Firebase", "Raspberry Pi", "Coral Edge TPU", "ESP8266", "REST APIs", "Microservices", "JWT", "Tailwind CSS", "Vite"];
...
const ProjectsSection = () => {
  const projects = [
    { num: "01", cat: "Computer Vision", title: "BananaSense AI", desc: "Multi-class banana ripeness classifier built with MobileNetV2 transfer learning on a custom image dataset covering multiple ripeness stages. Served via FastAPI REST API with a React.js frontend featuring drag-and-drop upload, real-time prediction output, and a per-class confidence score analytics dashboard.", tags: ["Python", "MobileNetV2", "Transfer Learning", "FastAPI", "React.js", "OpenCV", "REST API"], achieve: "End-to-end pipeline from dataset curation to deployed inference — multi-class classification validated across diverse real-world conditions.", link: "https://github.com/ankitnotnani" },
    { num: "02", cat: "NASA Space Apps Challenge 2025", title: "ChronoClime", desc: "Led team to Grand Finalist at NASA Space Apps Challenge 2025 on 'Will It Rain On My Parade?'. Designed the Adverse Condition Impact Score (ACIS) — a personalised 1–10 activity-centric weather risk metric. Integrated ESP8266 IoT gateway for hardware location input and built an AI weather chatbot with a fully mobile-responsive animated forecast UI.", tags: ["React", "TypeScript", "Vite", "Tailwind CSS", "FastAPI", "OpenWeatherMap API", "ESP8266", "IoT"], achieve: "Grand Finalist — NASA Space Apps Challenge 2025. Presented to NASA evaluators globally.", link: "https://github.com/ankitnotnani" },
    { num: "03", cat: "Smart India Hackathon 2025", title: "KASA", desc: "Software Lead (SIH25021) — AI-powered laser QR marking system for Indian Railways track components. Built QR lifecycle traceability syncing with UDM & TMS portals. Architected the cloud backend and a React analytics dashboard with failure-rate visualisations for field engineers.", tags: ["Raspberry Pi", "Coral Edge TPU", "MobileNetV3", "React", "Firebase", "AWS", "Python", "Dash/Plotly"], achieve: "Grand Finalist — Smart India Hackathon 2025. National-level selection.", link: "https://github.com/ankitnotnani" },
    { num: "04", cat: "NLP · Full-Stack", title: "IDEACT", desc: "AI platform mapping hackathon problem statements to all 17 UN SDGs using NLP. 3-layer architecture: React.js frontend → FastAPI backend → MongoDB. Outputs feasibility-scored project ideas with tech stack recommendations and week-by-week execution roadmaps.", tags: ["Python", "FastAPI", "React.js", "MongoDB", "NLP", "Scikit-learn", "REST APIs"], achieve: "94.12% F1-Macro score across all 17 UN SDG categories — distinguishing it from generic chatbots.", link: "https://github.com/ankitnotnani" },
    { num: "05", cat: "Distributed Systems", title: "ExamHub", desc: "Distributed online exam system with 5 Spring Boot microservices — Auth, Exam, Result, API Gateway, and Eureka Service Registry. JWT-based authentication with role-based access control for isolated concurrent exam sessions across multiple roles.", tags: ["Spring Boot", "Spring Cloud", "Eureka", "JWT", "MySQL", "React", "REST APIs", "Docker"], achieve: "Production-grade microservices architecture — concurrent multi-role session isolation with full auth pipeline.", link: "https://github.com/ankitnotnani" }
  ];
...
const ContactSection = () => (
  <section className="bg-dark px-5 sm:px-8 md:px-16 py-28 sm:py-36 md:py-44 flex flex-col items-center" id="contact">
    <FadeIn><span className="text-textMuted font-light uppercase tracking-[0.3em] text-xs md:text-sm">05 — Contact</span></FadeIn>
