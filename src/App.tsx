...
const AboutSection = () => (
  <section className="min-h-screen flex flex-col justify-center px-5 sm:px-8 md:px-16 py-20" id="about">
    ...
    <div className="max-w-3xl mx-auto mt-10">
      <AnimatedText 
        text="With hands-on experience in AI, machine learning, and full-stack development, i build intelligent systems, computer vision models, and scalable web applications. Currently interning at Empyrean Consultancy Services, developing crop readiness detection models using drone imagery."[cite: 2]
        className="text-textMain font-medium leading-relaxed text-[clamp(1rem,1.8vw,1.3rem)] mb-6 text-center" 
      />
      <AnimatedText 
        text="Grand Finalist at NASA Space Apps Challenge 2025 and Smart India Hackathon 2025. Alpha Batch at UPES — selected via AMCAT for top DSA tier. Associate Secretary at Avishkarnam Literary Club, and a regular event host at UURJA, Spandan, and Ukti."[cite: 2]
    ...
    <div className="flex justify-center flex-wrap mt-16 gap-8 sm:gap-16">
      <FadeIn delay={0.3}><AnimatedCounter target="2" label="Grand Finalist Titles"[cite: 2]</AnimatedCounter></FadeIn>
      <div className="hidden md:block w-px bg-white/10" />
      <FadeIn delay={0.4}><AnimatedCounter target="6" label="Major Projects"[cite: 2]</AnimatedCounter></FadeIn>
      <div className="hidden md:block w-px bg-white/10" />
      <FadeIn delay={0.5}><AnimatedCounter target="8.0" label="CGPA / 10"[cite: 2]</AnimatedCounter></FadeIn>
      <div className="hidden md:block w-px bg-white/10" />
      <FadeIn delay={0.6}><AnimatedCounter target="50" label="Engagement Uplift" suffix="%"[cite: 2]</AnimatedCounter></FadeIn>
    </div>
  </section>
);
...
const JourneySection = () => {
  const journey = [
    { year: "2021", title: "The Beginning", desc: "Class X ICSE — 91%. First encounter with structured learning and problem-solving at St. George's College, Agra."[cite: 2] },
    { year: "2023", title: "Class XII & Transition", desc: "Class XII ICSE — 81%. Moved to UPES Dehradun, B.Tech CSE (AI & ML). Python, data structures, and the realization that code is a thinking tool."[cite: 2] },
    { year: "2024", title: "First Projects & Social Impact", desc: "Built ExamHub online exam platform with Spring Boot microservices. Completed a Social Internship at Chhanv Foundation, digitizing records and supporting campaigns at Sheroes Hangout Cafe, Agra."[cite: 2] },
    { year: "2025", title: "Full-Stack AI & Media Strategy", desc: "Developed BananaSense AI and IDEACT platforms. Served as Tech & Social Media Intern at Binary Keeda, scaling audience engagement by 50% via data-backed content mapping."[cite: 2] },
    { year: "E. 2025", title: "National Grand Finals", desc: "Software Lead for Team KASA at Smart India Hackathon Grand Finals (Railway traceability system). Team Lead for ChronoClime at NASA Space Apps Challenge Grand Finals globally."[cite: 2] },
    { year: "2026", title: "Industry & Present", desc: "AI & ML Project Intern at Empyrean Consultancy Services. Designing computer vision models and real-time inference software for automated object readiness detection."[cite: 2] }
  ];
...
const ExpertiseSection = () => {
  const expertise = [
    { num: "01", title: "AI & Machine Learning", desc: "End-to-end ML pipelines using TensorFlow/Keras, MobileNetV2 transfer learning, Scikit-learn, and OpenCV — from dataset curation and model training to optimised inference deployment."[cite: 2] },
    { num: "02", title: "Computer Vision", desc: "Real-time image classification and object detection with fine-tuned CNNs. Applied to crop readiness detection (drone imagery), banana ripeness grading, and railway QR traceability."[cite: 2] },
    { num: "03", title: "Full-Stack Development", desc: "React.js + TypeScript frontends with Tailwind CSS, connected to FastAPI or Spring Boot backends with REST APIs, MongoDB/MySQL, and Firebase integration."[cite: 2] },
    { num: "04", title: "Backend & Distributed Systems", desc: "Scalable microservice architectures with Spring Boot, Spring Cloud, Eureka, JWT auth, and Docker — supporting concurrent multi-role isolated sessions."[cite: 2] },
    { num: "05", title: "DSA & Problem Solving", desc: "Strong foundations in Arrays, Linked Lists, Trees, Graphs, and Dynamic Programming. Alpha Batch at UPES (top DSA tier, selected via AMCAT). Consistent LeetCode practice."[cite: 2] }
  ];

  // FIXED & COMPREHENSIVELY UPDATED SKILLS PACK
  const tags = [
...
// --- NEW DESIGNER CERTIFICATIONS SECTION ---
const CertificationsSection = () => {
  const certs = [
    { title: "AWS Foundations of Prompt Engineering", issuer: "Amazon Web Services", date: "Jun 2026", path: "/certs/aws-prompt.pdf"[cite: 2] },
    { title: "SQL & Relational Databases 101", issuer: "IBM Skills Network", date: "Jun 2026", path: "/certs/ibm-sql.pdf"[cite: 2] },
    { title: "Career Essentials in Generative AI", issuer: "Microsoft & LinkedIn", date: "Jun 2026", path: "/certs/microsoft-genai.pdf"[cite: 2] },
    { title: "Data Analytics Job Simulation", issuer: "Deloitte via Forage", date: "Jun 2026", path: "/certs/deloitte-analytics.pdf"[cite: 1] }
  ];
  ...
  <section className="bg-dark px-5 sm:px-8 md:px-16 py-28 sm:py-36 md:py-44 flex flex-col items-center" id="contact">
    ...
    <FadeIn delay={0.25}>
      <p className="text-textMain/60 font-light text-center max-w-md text-[clamp(0.9rem,1.5vw,1.1rem)] mt-8">
        I'm actively looking for AI/ML and backend SDE internship and full-time roles. If something here resonated, just reach out.[cite: 2]
      </p>
    </FadeIn>
    <FadeIn delay={0.4} className="flex flex-col sm:flex-row gap-4 sm:gap-6 mt-12">
      <ContactButton href="mailto:ankitnotnani6497@gmail.com">Email Me ↗</ContactButton>[cite: 2]
      <GhostButton href="https://www.linkedin.com/in/ankit-notnani/">LinkedIn ↗</GhostButton>[cite: 2]
      <GhostButton href="https://github.com/Ankitnotnani">GitHub ↗</GhostButton>[cite: 2]
    </FadeIn>
    
    <FadeIn delay={0.5} className="flex gap-4 sm:gap-8 items-center mt-8 flex-wrap justify-center">
      <a href="https://www.linkedin.com/in/ankit-notnani/" target="_blank" rel="noreferrer" className="text-textMuted font-light uppercase tracking-widest text-xs hover:text-textMain transition-colors">in/ankit-notnani</a>[cite: 2]
      <span className="text-textMuted text-xs">•</span>
      <a href="https://github.com/Ankitnotnani" target="_blank" rel="noreferrer" className="text-textMuted font-light uppercase tracking-widest text-xs hover:text-textMain transition-colors">github.com/Ankitnotnani</a>[cite: 2]
      <span className="text-textMuted text-xs">•</span>
      <span className="text-textMuted font-light uppercase tracking-widest text-xs">Dehradun, India</span>[cite: 2]
    </FadeIn>
